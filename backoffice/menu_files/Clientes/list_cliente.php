                    ...
                    <table class="table table-hover table-striped" id="myTable">
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td>Niger</td>
                              <td>
                                <button type="button" rel="tooltip" title="Carrinho" class="btn btn-success btn-simple btn-xs" onclick="mySubFunction(1)">
                                    <i class="fa fa-shopping-cart"></i>
                                </button>
                                <button type="button" rel="tooltip" title="Informação" class="btn btn-warning btn-simple btn-xs" onclick="mySubFunction(2)">
                                    <i class="fa fa-list-alt"></i>
                                </button>
                                <button type="button" rel="tooltip" title="Editar" class="btn btn-info btn-simple btn-xs" onclick="mySubFunction(3)">
                            ...
                            <tr>
                              ...
                              <td>Curaçao</td>
                              <td>
                                <button type="button" rel="tooltip" title="Carrinho" class="btn btn-success btn-simple btn-xs" onclick="mySubFunction(4)">
                                    <i class="fa fa-shopping-cart"></i>
                                </button>
                                <button type="button" rel="tooltip" title="Informação" class="btn btn-warning btn-simple btn-xs" onclick="mySubFunction(2)">
                                    <i class="fa fa-list-alt"></i>
