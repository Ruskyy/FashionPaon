...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 30 oct. 2019 à 10:13
...
(28, '12€', 1, '2019/10/21 15:14:40', 0, 2, 1, '2019/10/21 15:24:40');
...
(32, 1, 'A encomenda de [&quantidade&] [&nome&] com o tamanho [&tamanho&] foi entregue agora ao armazem.', 0, 2, 28);
...
--
ALTER TABLE `ad_encomendas`
  MODIFY `ad_encomendas_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT pour la table `ad_notification`
--
ALTER TABLE `ad_notification`
  MODIFY `ad_notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
