...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 13 mars 2019 à 16:59
...
CREATE TABLE `ad_encomendas` (
  ...
  `ad_encomendas_descricao` varchar(150) NOT NULL,
  `ad_encomendas_quantidades` int(11) NOT NULL,
  `ad_encomendas_data` datetime NOT NULL,
  `ad_encomendas_estado` int(11) NOT NULL,
  `ad_encomendas_idstock` int(11) NOT NULL
...
(13, 'dsa', '202cb962ac59075b964b07152d234b70', 'das', 'asd', '0000-00-00', 'das-123', '1232-123', 0, 2147483647, 123123123, 'dsa@gmail.com', 1, 'images/unknown.png');
...
(1, 1, 1, 'images/uploads/JGSC2n5jbYqbPWXCYbzqsAYz4n8GelxGIl1tkzaQ9bGu4zms00od8RQtiA2hNtd3pWdhiiTOWJcksyAdkMAOk06dMHBHk5mSdFsN.png'),
(2, 1, 2, 'images/uploads/ulzQtXPbl21gZiAG1GDZZboQOe9s7ayAHT6e2pYh5wdqrEobqKiRQzE8kdEThOqAZsdFvpKXNsieDdFEtbfSwZ0Isp5LUq5Ut1d4.png');
...
(7, 0, 'images/slider/nC72yzDMTcSbzD6LUdHHQ3YIyJMG2gc5UMUQXATsHbUfl3B8PyOyDYudf9tbwO1UKChp0bE2D40i83zbnGg6BZCEDiCPizgk0UQ3.jpg', 'Novo Slider', 'bo6', 'fadeInUp', 'Este é dinamico !', 'fadeInDown', 'on', 'OLHA UM BUTAO', 'zoomIn', '');
...
--
ALTER TABLE `ad_encomendas`
  MODIFY `ad_encomendas_id` int(11) NOT NULL AUTO_INCREMENT;
