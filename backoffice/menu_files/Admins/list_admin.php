...
session_start();
  ...
  $tipo = $_POST['tipo'];
  $output = '';
  $dado =mysqli_query($conn,"SELECT cliente_id, cliente_username, cliente_nome, cliente_apelido, cliente_email  FROM cliente WHERE cliente_tipo = 1");
  $output .='
  <div class="container-fluid">
      <div class="row">
          <div class="col-md-6">
              <div class="card">
                  <div class="header">
                      <h4 class="title">Admins > Listar</h4>
                  </div>
